...
const integrations = [
  ...
  { name: "v0.dev", category: "VibeCoding" },
  { name: "Cursor", category: "AI Development" },
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        >
          ...
          <p className="text-xl text-muted-foreground">
            From no-code platforms to cutting-edge AI. Whatever your system needs, I have mastered it.
          </p>
        </div>
