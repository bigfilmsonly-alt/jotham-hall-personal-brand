...
const steps = [
  {
    ...
    description: "We identify bottlenecks, revenue leaks, and automation opportunities in your business.",
    code: `// Business Audit Results
{
  bottlenecks: ['manual_follow_up'],
  revenue_leaks: ['cart_abandon'],
  ...
  },
  {
    ...
    description: "Custom systems tailored to your business - AI workflows, CRM automation, or full infrastructure.",
    code: `// System Architecture
{
  lead_capture: 'automated',
  follow_up: 'AI_powered',
  conversion: 'systematized',
  scale: 'infinite'
}`,
  },
  {
    ...
    description: "Systems go live. You stop being the bottleneck. Growth becomes predictable.",
    code: `// Results Dashboard
{
  leads_automated: true,
  overhead_reduced: '40%',
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="mb-16 lg:mb-24 text-center lg:text-left">
          ...
          >
            Your next level
            <br />
            <span className="text-background/50">is engineered.</span>
          </h2>
        </div>
          ...
          <div className="space-y-0">
            {steps.map((step, index) => (
              <button
                ...
                className={`w-full text-center lg:text-left py-6 lg:py-8 border-b border-background/10 transition-all duration-500 group ${
