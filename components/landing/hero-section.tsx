...
export function HeroSection() {
  ...
  return (
    <section id="hero" className="relative min-h-screen flex flex-col justify-center overflow-hidden" itemScope itemType="https://schema.org/Person">
      ...
      <div className="absolute right-1/2 translate-x-1/2 sm:right-0 sm:translate-x-0 top-[45%] sm:top-[35%] lg:top-auto lg:bottom-[-10%] lg:right-[-5%] lg:translate-x-0 w-[450px] h-[450px] sm:w-[700px] sm:h-[700px] lg:w-[1200px] lg:h-[1200px] opacity-25 sm:opacity-35 lg:opacity-40 pointer-events-none">
        <AnimatedSphere />
      </div>
