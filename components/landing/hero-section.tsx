...
export function HeroSection() {
  ...
  return (
    <section id="hero" className="relative min-h-screen flex flex-col justify-center overflow-hidden" itemScope itemType="https://schema.org/Person">
      ...
      <div className="absolute right-1/2 translate-x-1/2 sm:right-0 sm:translate-x-0 top-[35%] sm:top-[30%] lg:top-[15%] w-[500px] h-[500px] sm:w-[700px] sm:h-[700px] lg:w-[900px] lg:h-[900px] opacity-25 sm:opacity-35 lg:opacity-40 pointer-events-none">
        <AnimatedSphere />
      </div>
